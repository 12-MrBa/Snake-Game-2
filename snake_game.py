...
# import time
# pygame.init()
# # Set our display screen
# # Create our player character
# # Define our player movement
# # Create a scoring system (eats)
# # Game ending (hits a wall, bites themself)
#
# screen_width = 720
# screen_height = 480
...
# cool_red = pygame.Color(249,9,45)
# cool_green = pygame.Color(52,170,86)
...
#     gameover_surface = gameover_font.render(f"You're Trash, Game over \nYour score:{score}", True, red)
...
#         pygame.draw.rect(screen, cool_green, pygame.Rect(block[0],block[1],10,10))
#
#     pygame.draw.rect(screen, cool_red, pygame.Rect(fruit_position[0],fruit_position[1],10,10))
#
#     if score == 3456:
#         win()
#
...
#go to email inbox and download the trophy.txt file that i sent
#put that file in the same directory as where you saved this program
#define this function
def win():
    print("\nCONGRATULATIONS!\nYou have successfully completed the game, somehow...")
...
def game_over():
    ...
    gameover_surface = gameover_font.render(f"You're trash! Final score: {score}",True, orange) # Creates a surface for our game_over message
...
while True:
    ...
    pygame.draw.rect(screen, cool_red, pygame.Rect(fruit_position[0],fruit_position[1],10,10)) # Draws a new fruit block on screen
